...
private fun AlertCard() {
    ...
    Card(elevation = animatedElevation) {
        Column {
            ...
            RallyDivider(
                    modifier =
                            Modifier.padding(start = RallyDefaultPadding, end = RallyDefaultPadding)
            )
    ...
    Row(
            modifier =
                    Modifier.padding(RallyDefaultPadding)
                            // Regard the whole row as one semantics node. This way each row will
                            // receive focus as
                            // a whole and the focus bounds will be around the whole row content.
                            // The semantics
                            // properties of the descendants will be merged. If we'd use
                            // clearAndSetSemantics instead,
